...
from models.planning.recommendation.get_all_recommendations import get_all_recommendations
from models.planning.recommendation.get_eligible_recommendations import get_eligible_recommendations
...
recs = get_all_recommendations(unmet, catalog)
eligible = get_eligible_recommendations(recs, completed, completed, graph)
print(eligible)